package almacenapp.app.tecsup.com.almacenapp.activities;
...
import almacenapp.app.tecsup.com.almacenapp.ApiService;
import almacenapp.app.tecsup.com.almacenapp.ApiServiceGenerator;
import almacenapp.app.tecsup.com.almacenapp.R;
import almacenapp.app.tecsup.com.almacenapp.ResponseMessage;
...
public class RegisterActivity extends AppCompatActivity {
        ...
        if(requestCode == CAPTURE_IMAGE_REQUEST){
            ...
            if(resultCode == RESULT_OK){
                try {
                    ...
                    Bitmap b2 = scaleBitmapDown(bitmap, 800);
                    imagePreview.setImageBitmap(b2);
                } catch (Exception e) {
    ...
    public void callRegister(View view){
        ...
        try {
            ...
            Log.d("ABC", "Ruta: " + mediaFileUri);
            Log.d("ABC", "Ruta: " + mediaFileUri.getPath());
